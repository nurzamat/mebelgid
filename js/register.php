                ...
                <div class="account-create">
                    ...
                    <form action="" method="post" id="form-validate" enctype="multipart/form-data">
                        <div class="fieldset">
                            ...
                            <ul class="form-list">
                                ...
                                <li>
                                    ...
                                    <div class="input-box">
                                        <input type="text" name="email" id="email_address" value="" title="Email" class="input-text validate-email required-entry" />
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="buttons-set form-buttons">
                            ...
                            <button type="submit" class="button" title="Submit"><span><span>Зарегистрироваться</span></span></button>
                        </div>
                    </form>
                    <script type="text/javascript">
                        //<![CDATA[
