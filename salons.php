...
$query = "SELECT * FROM users WHERE user_status='2' AND user_city='$city'";

if (isset($_GET['q']))
{
    $query = $query." AND user_salonname LIKE '%$_GET[q]%'";
}

//paging
$num_rec_per_page = 25;
$salonsQ = queryMysql($query);
$total_records = mysql_num_rows($salonsQ);  //count number of records
...
<div class="wrapper">
    <div class="page">
        ...
        <div>
            <div class="list">
                <? while($salon = mysql_fetch_object($salonsQ)) { ?>
                    <div class="salonItem">
                        <a href="../<?=$salon->user_salondomen?>" class="salonName"><img src="uploads/<?=$salon->user_login?>_100.jpg" alt="<?=$salon->user_salonname?>" title="<?=$salon->user_salonname?> | MebelGid.kg" /><?=$salon->user_salonname?></a><br/>
                        <div class="addr"><?=$salon->user_salonname?> -
                            <?=$salon->user_address?><br/><span class="phone"><nobr><?=$salon->user_phone?></nobr></span>, <span class="phone"><nobr><?=$salon->user_phone2?></nobr></span>, <span class="phone"><nobr><?=$salon->user_phone3?></nobr></span></div>
                        <div class="salonTags">Мебель для дома: <a href="http://mebelsosklada.mebel.kz/cat/10101">Гарнитуры</a>, <a href="http://mebelsosklada.mebel.kz/cat/10103">Уголки</a>, <a href="http://mebelsosklada.mebel.kz/cat/10201">Диваны, диван-кровати</a>, <a href="http://mebelsosklada.mebel.kz/cat/10301">Гостиные, витрины</a>, <a href="http://mebelsosklada.mebel.kz/cat/10302">Прихожие</a>, <a href="http://mebelsosklada.mebel.kz/cat/10303">Шкафы, шкафы-купе</a>, <a href="http://mebelsosklada.mebel.kz/cat/10304">Домашние кабинеты</a>, <a href="http://mebelsosklada.mebel.kz/cat/10305">Столы</a>, <a href="http://mebelsosklada.mebel.kz/cat/10306">Стулья</a>, <a href="http://mebelsosklada.mebel.kz/cat/10307">Тумбы, комоды, подставки</a>, <a href="http://mebelsosklada.mebel.kz/cat/10308">Журнальные столики</a>, <a href="http://mebelsosklada.mebel.kz/cat/10401">Кровати</a>, <a href="http://mebelsosklada.mebel.kz/cat/10402">Гарнитуры</a>, <a href="http://mebelsosklada.mebel.kz/cat/10501">Гарнитуры</a>, <a href="http://mebelsosklada.mebel.kz/cat/10502">Комбинированные модули</a>, <a href="http://mebelsosklada.mebel.kz/cat/10505">Кровати, комоды</a>, <a href="http://mebelsosklada.mebel.kz/cat/10506">Двухярусные кровати</a>, <a href="http://mebelsosklada.mebel.kz/cat/10507">Столы, стулья</a>, <a href="http://mebelsosklada.mebel.kz/cat/10509">Компьютерные столы</a>, <a href="http://mebelsosklada.mebel.kz/cat/10510">Шкафы</a><br />Всё для интерьера: <a href="http://mebelsosklada.mebel.kz/cat/212">Вешалки</a></div></div>
                <?}?>
                <div class="toolbar">
